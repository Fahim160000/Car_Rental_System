...
##Display rented cars of customers
...
print(f"Rental ID:{rental2.rental_id},Customer:{rental2.customer.name},Car:{rental2.car.make},Renatl Fee:INR{rental2.rental_fee}")